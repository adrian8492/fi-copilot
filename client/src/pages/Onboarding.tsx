      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {step === 2 && (
          <Card>
            ...
            <CardContent className="space-y-4">
              {products.map((p, idx) => {
                // Phase 6 issue 3b — derive computed retail for cost_plus rows
                // (matches db.ts:computeRetailPrice).
                ...
                return (
                  <div key={idx} className="rounded-md border border-border p-3 space-y-2">
                    {/* Row 1: type / name / pricing-model toggle / trash */}
                    ...
                    {/* Row 2 — fixed_retail: single retail input. cost_plus: cost + markup + computed. */}
                    {p.pricingModel === "fixed_retail" ? (
                      ...
                      <div className="grid grid-cols-12 gap-2 items-end bg-muted/30 rounded-md p-2 -mx-1">
                        <div className="col-span-3 space-y-1">
                          ...
                          <Input
                            type="number"
                            value={p.costToDealer}
                            onChange={(e) => updateRow({ costToDealer: e.target.value })}
                          />
                        </div>
                        <div className="col-span-3 space-y-1">
                          ...
                          <Input
                            type="number"
                            value={p.markupAmount}
                            onChange={(e) => updateRow({ markupAmount: e.target.value })}
                          />
                        </div>
                        <div className="col-span-2 space-y-1">
                          ...
                          <Select
                            value={p.markupType}
                            onValueChange={(v) => updateRow({ markupType: v as MarkupType })}
                          >
                            <SelectTrigger><SelectValue /></SelectTrigger>
                            <SelectContent>
