...
vi.mock("./db", () => ({
  ...
  getProductMenuItemById: vi.fn().mockResolvedValue({ id: 1, dealershipId: 1, productType: "vehicle_service_contract", displayName: "VSA", providerName: null, description: null, costToDealer: null, retailPrice: null, termMonths: null, maxMileage: null, isActive: true, sortOrder: 0, createdAt: new Date(), updatedAt: new Date() }),
